      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Transform your abandoned projects into your competitive advantage. 
              Learn from failures, identify patterns, and build better.
            </p>
            <div className="text-gray-500 text-xs">
              © 2025 Project Graveyard. All rights reserved.
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#features" className="text-gray-400 hover:text-gray-200 transition-colors">
                  Features
                </Link>
              </li>
              <li>
                <Link href="#how-it-works" className="text-gray-400 hover:text-gray-200 transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/auth" className="text-gray-400 hover:text-gray-200 transition-colors">
                  Get Started
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-xs mb-4 md:mb-0">
            Made with ❤️ for developers who ship (and sometimes don't)
          </div>
